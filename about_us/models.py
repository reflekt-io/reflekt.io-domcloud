...
class Contact(models.Model):
    full_name = models.CharField(verbose_name="Full Name", max_length=200, null=True, blank=True)
    query_topic = models.CharField(verbose_name="Query Topic",max_length=200, null=True, blank=True)
